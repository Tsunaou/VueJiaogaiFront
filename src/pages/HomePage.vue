  ...
  <div class="demo-1">
    <div class="container">
      <header class="codrops-header">
        <h1>教育改变晋江七周年回顾<span>PC Mobile Fit Version</span></h1>
        <nav class="codrops-demos">
          <a href="index.html">2012</a>
          <a href="index2.html">2013</a>
          <a href="index3.html">2014</a>
          <a href="index4.html">2015</a>
          <a href="index5.html">2016</a>
          <a href="index6.html">2017</a>
          <a class="current-demo" href="index7.html">2018-Future</a>
        </nav>
      </header>
      <div class="content">
          ...
          <div class="card">
            <div class="card__container card__container--closed">
              <svg class="card__image" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1920 500" preserveAspectRatio="xMidYMid slice">
                ...
                <image clip-path="url(#clipPath2)" width="1920" height="500" xlink:href="../../static/img/b.jpg"></image>
              </svg>
              <div class="card__content">
                <i class="card__btn-close fa fa-arrow-left">点击此处返回</i>
                ...
                <div class="card__copy">
                  <div class="meta">
                    <img class="meta__avatar" src="../../static/img/authors/2.png" alt="author02" />
          ...
          <div class="card">
            <div class="card__container card__container--closed">
              <svg class="card__image" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1920 500" preserveAspectRatio="xMidYMid slice">
                ...
                <image clip-path="url(#clipPath3)" width="1920" height="500" xlink:href="../../static/img/c.jpg"></image>
              </svg>
              <div class="card__content">
                <i class="card__btn-close fa fa-arrow-left">点击此处返回</i>
                <div class="card__caption">
                ...
                <div class="card__copy">
                  <div class="meta">
                    <img class="meta__avatar" src="../../static/img/authors/3.png" alt="author03" />
          ...
          <div class="card">
            <div class="card__container card__container--closed">
              <svg class="card__image" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1920 500" preserveAspectRatio="xMidYMid slice">
                ...
                <image clip-path="url(#clipPath4)" width="1920" height="500" xlink:href="../../static/img/d.jpg"></image>
              </svg>
              <div class="card__content">
                <i class="card__btn-close fa fa-arrow-left">点击此处返回</i>
                <div class="card__caption">
          ...
          <div class="card">
            <div class="card__container card__container--closed">
              <svg class="card__image" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1920 500" preserveAspectRatio="xMidYMid slice">
                ...
                <image clip-path="url(#clipPath5)" width="1920" height="500" xlink:href="../../static/img/e.jpg"></image>
              </svg>
              <div class="card__content">
                <i class="card__btn-close fa fa-arrow-left">点击此处返回</i>
                <div class="card__caption">
                ...
                <div class="card__copy">
                  <div class="meta">
                    <img class="meta__avatar" src="../../static/img/authors/5.png" alt="author05" />
          ...
          <div class="card">
            <div class="card__container card__container--closed">
              <svg class="card__image" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1920 500" preserveAspectRatio="xMidYMid slice">
                ...
                <image clip-path="url(#clipPath6)" width="1920" height="500" xlink:href="../../static/img/f.jpg"></image>
              </svg>
              <div class="card__content">
                <i class="card__btn-close fa fa-arrow-left">点击此处返回</i>
                <div class="card__caption">
                ...
                <div class="card__copy">
                  <div class="meta">
                    <img class="meta__avatar" src="../../static/img/authors/6.png" alt="author06" />
...
<script>
  import Page1Card1 from "../components/page1/card1";
  export default {
    name: 'HomePage',
    components: {Page1Card1},
    data () {
      return {
        msg: 'Welcome to 教育改变晋江'
      }
    },
